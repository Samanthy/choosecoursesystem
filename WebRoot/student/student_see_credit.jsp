      ...
      <table width="709" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr bgcolor="#6699FF"> 
          <td colspan="3"> 
              ...
              <tr> 
                <td colspan="2" valign="top"><div align="center"><font color="#FFFFFF" size="3"><strong>查看以往所选课程和所得学分</strong></font></div></td>
              </tr>
              <tr align="left"> 
                <td colspan="2" valign="top" bordercolor="#FFFFFF"> <hr/> <div style="display:block;overflow-y:scroll;overflow-x:auto;height:100px;"> 
                    <table cellspacing='0' cellpadding='0' width="100%"  border="1">
                      <tr class="tabhead"> 
                        ...
                        <td><div align="center">所得学分</div></td>
                      </tr>
                      <c:if test="${fn:length(requestScope.see_credit)>0 }" var="flag">
                       ...
                       <c:if test="${!flag }">
	                       <tr> 
	                        <td colspan="10" valign="top"><div align="center"><font color="#FFFFFF">你还没有任何以往选修课信息</font></div></td>
	                      </tr>
                       </c:if>
                    </table>
                  </div></td>
