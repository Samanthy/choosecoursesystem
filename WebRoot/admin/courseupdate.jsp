  ...
  <tr>
    <td width="444" align="right"> 
      <table width="459" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr bgcolor="#6699FF"> 
          <td colspan="3">
          	<html:form action="updateCourse" method="post"> 
            <table width="450" border="0" cellspacing="1" cellpadding="1">
              
                <tr> 
                  <td colspan="2" valign="top"><div align="center"><font color="#FFFFFF"><strong>修改选修课</strong></font></div></td>
                </tr>
                <tr> 
                  <td align="right" valign="top"><font color="#FFFFFF">课程编号：</font></td>
				  					<td align="left"> <html:text property="cid" disabled="true" size="20"/> </td>
                </tr>
                <tr> 
                  <td colspan="2"> <html:hidden property="id"/> </td>
                </tr>
                <tr> 
                  <td align="right" valign="top"><font color="#FFFFFF">课程名称：</font></td>
                  <td align="left"> <html:text property="cname" size="20"  onblur="mouseOutEvn(this);" styleClass="moveout" onfocus="mouseOverEvn(this);"/> </td>
                </tr>
                <tr> 
                  <td width="171" align="right" valign="top"><font color="#FFFFFF">开课日期：</font></td>
                  <td width="272" align="left"> <html:text property="startDate"  size="20"  onblur="mouseOutEvn(this);" styleClass="moveout" onfocus="mouseOverEvn(this);"/></td>
                </tr>
                <tr> 
                  <td align="right" valign="top"><font color="#FFFFFF">结课日期：</font></td>
                  <td align="left"> <html:text property="endDate" size="20"  onblur="mouseOutEvn(this);" styleClass="moveout" onfocus="mouseOverEvn(this);"/></td>
                </tr>
                <tr> 
                  <td align="right" valign="top"><font color="#FFFFFF">该课学分：</font></td>
                  <td align="left"><html:text property="credit" size="20" onblur="mouseOutEvn(this);" styleClass="moveout" onfocus="mouseOverEvn(this);"/></td>
                </tr>
                <tr> 
                  <td align="right" valign="top"><font color="#FFFFFF">上课时间段：</font></td>
                  <td align="left"><html:text property="schoolTime" size="20" onblur="mouseOutEvn(this);" styleClass="moveout" onfocus="mouseOverEvn(this);"/></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td align="left"> <html:text property="tid"  onblur="mouseOutEvn(this);" styleClass="moveout" onfocus="mouseOverEvn(this);"/><c:if test="${requestScope.tidnotexists==1}">
                ...
                <tr align="center"> 
                    <td colspan="2" valign="top" name="error"><font color="#FF0000"><strong><html:errors property="all" /></strong></font></td>
                </tr>
